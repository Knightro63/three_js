...
enum DistanceToType{manhattan,chebyshev,quadratic,squared,euclidean}
...
class Terrain{
  ...
  ///   between 0 and 1 and returns a float between 0 and 1.
  /// [TerrainOptions] edges = {top: true, bottom: true, left: true, right: true}
  ...
  /// 
  /// [void Function(Float32List,TerrainOptions)] method
  ...
  ///    final material = THREE.Terrain.generateBlendedMaterial([
