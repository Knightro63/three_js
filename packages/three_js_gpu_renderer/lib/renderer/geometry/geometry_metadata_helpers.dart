...
import 'geometry_descriptor.dart';
...
extension MaterialDescriptorGeometryExtensions on MaterialDescriptor {
  ...
  /// 
  /// This helper is used by both Vulkan and gpu renderers to ensure consistent
  ...
  GeometryBuildOptions buildGeometryOptions(BufferGeometry geometry) {
    ...
    bool hasAttribute(GeometryAttribute attribute) {
      return switch (attribute) {
        ...
        GeometryAttribute.lineDistance => geometry.hasAttributeFromString('lineDistance'),
        GeometryAttribute.pointSize => geometry.hasAttributeFromString('pointSize'),
      };
    }
