...
import 'package:gpux/gpux.dart' as gpux; // Adjust based on your exact gpux layout location
...
class MeshBatch {
  ...
  void render({
    required gpux.GpuRenderPassEncoder renderPass,
    required void Function(Mesh, gpux.GpuRenderPassEncoder) renderMesh,
  }) {
