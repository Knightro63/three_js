    ...
    if (texture != null) {
      ...
      if (isEquirectMap || isCubeMap) {
        ...
        if (texture.isRenderTargetTexture && texture.pmremVersion != currentPMREMVersion) {
					...
					//renderTarget = isEquirectMap ? pmremGenerator?.fromEquirectangular( texture: texture, renderTarget ) : pmremGenerator?.fromCubemap( texture, renderTarget );
          ...
          if (renderTarget != null) {
            ...
            if ((isEquirectMap && image != null && image.height > 0) ||
              ...
              //renderTarget = isEquirectMap ? pmremGenerator!.fromEquirectangular(texture: texture) : pmremGenerator!.fromCubemap(texture);
              cubeUVmaps.set(texture, renderTarget);
