...
// class WebGLCubeRenderTarget extends CubeRenderTarget {
//   WebGLCubeRenderTarget([int size = 1, RenderTargetOptions? options]) : super(size, options) {
...
//   @override
//   WebGLCubeRenderTarget fromEquirectangularTexture(Renderer renderer, Texture texture) {
