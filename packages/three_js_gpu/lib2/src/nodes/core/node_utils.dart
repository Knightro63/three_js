...
class NodeUtils {
  ...
  static int cyrb53Int(List<int> value, [int seed = 0 ]) {
    int h1 = 0xdeadbeef ^ seed, h2 = 0x41c6ce57 ^ seed;

    for ( int i = 0, val; i < value.length; i ++ ) {
      val = value[ i ];
  ...
  static int cyrb53String(String value, [int seed = 0 ]) {
    int h1 = 0xdeadbeef ^ seed, h2 = 0x41c6ce57 ^ seed;

    for ( int i = 0, ch; i < value.length; i ++ ) {
      ch = value.codeUnits[i];
   ...
   */
  static final hashString = (String str ) => cyrb53String( str );
   ...
   * @return {number} The hash.
   */
  static final hashArray = (List<int> array ) => cyrb53Int( array );
  ...
  //  * @return {number} The hash.
  //  */
  // final hash = ( ...params ) => cyrb53( params );

  // final typeFromLength = Map( [
  //   [ 1, 'float' ],
  //   [ 2, 'vec2' ],
  //   [ 3, 'vec3' ],
  //   [ 4, 'vec4' ],
  ...
  //   throw ( 'THREE.NodeUtils: Unsupported type: ${type}' );
