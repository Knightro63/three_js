...
class Geometries extends DataMap {
  ...
  WeakMap attributeCall = new WeakMap();
	 ...
	 */
	bool has(Object renderObject ) {
		final geometry = (renderObject as RenderObject).geometry;
	 ...
	 * @param {RenderObject} renderObject - The render object.
	 */
	void initGeometry(RenderObject renderObject ) {
		final geometry = renderObject.geometry;
    if(geometry is! BufferGeometry) return;
