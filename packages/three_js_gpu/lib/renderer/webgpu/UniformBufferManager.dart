...
class UniformBufferManager {
  ...
  bool updateUniforms({
    ...
    // Indices 88 to 127 remain empty padding floats to complete the 512-byte stride

    final offset = dynamicOffset(drawIndex);
    if (offset + 512 > uniformBufferSize) return false;

    // Upload raw float list to your working framework write queue
