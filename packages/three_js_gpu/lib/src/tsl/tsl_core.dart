...
final Map NodeElements = new Map();
...
addMethodChaining( name, nodeElement ) {
	...
	if ( nodeElement != 'function' ) throw new Error( 'THREE.TSL: Node element $name is not a function' );
...
final vec2 = new ConvertType( 'vec2' );
final ivec2 = new ConvertType( 'ivec2' );
final uvec2 = new ConvertType( 'uvec2' );
final bvec2 = new ConvertType( 'bvec2' );

final vec3 = new ConvertType( 'vec3' );
final ivec3 = new ConvertType( 'ivec3' );
final uvec3 = new ConvertType( 'uvec3' );
final bvec3 = new ConvertType( 'bvec3' );

final vec4 = new ConvertType( 'vec4' );
final ivec4 = new ConvertType( 'ivec4' );
final uvec4 = new ConvertType( 'uvec4' );
final bvec4 = new ConvertType( 'bvec4' );

final mat2 = new ConvertType( 'mat2' );
final mat3 = new ConvertType( 'mat3' );
final mat4 = new ConvertType( 'mat4' );

final string = ( value = '' ) => nodeObject( new ConstNode( value, 'string' ) );
final arrayBuffer = ( value ) => nodeObject( new ConstNode( value, 'ArrayBuffer' ) );
