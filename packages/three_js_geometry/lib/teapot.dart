 ...
 *
 * ```js
 * final geometry = TeapotGeometry( 50, 18 );
 * final material = THREE.MeshBasicMaterial( { color: 0x00ff00 } );
 * final teapot = THREE.Mesh( geometry, material );
 * scene.add( teapot );
 * ```
 *
...
class TeapotGeometry extends BufferGeometry {
	 ...
	 */
	TeapotGeometry({double size = 50, int segments = 10, bool bottom = true, bool lid = true, bool body = true, bool fitLid = true, bool blinn = true }):super(){
		...
		final notDegenerate = ( vtx1, vtx2, vtx3 ) => // if any vertex matches, return false
		...
		this.setIndex( Uint16BufferAttribute.fromList( indices, 1 ) );
		this.setAttributeFromString( 'position', Float16BufferAttribute.fromList( vertices, 3 ) );
		this.setAttributeFromString( 'normal', Float16BufferAttribute.fromList( normals, 3 ) );
		this.setAttributeFromString( 'uv', Float16BufferAttribute.fromList( uvs, 2 ) );
