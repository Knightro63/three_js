...
class WebglNodesPoints extends StatefulWidget {
  ...
  const WebglNodesPoints({super.key, required this.fileName});
...
class _State extends State<WebglNodesPoints> {
  ...
  Future<void> setup() async {
    ...
    final teapotGeometry = TeapotGeometry( 50, 7 );
    ...
    final positionAttribute = teapotGeometry.getAttribute( 'position' );
    ...
    final fireMap = three.TextureLoader().fromAsset( 'textures/sprites/firetorch_1.jpg' );
