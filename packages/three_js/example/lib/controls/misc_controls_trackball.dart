...
class _MyAppState extends State<misc_controls_trackball> {
  ...
  initPage() {
    ...
    controls = three.TrackballControls(camera, _globalKey);
    ...
    var geometry = CylinderGeometry(0, 10, 30, 4, 1);
    var material = three.MeshPhongMaterial.fromMap({"color": 0xffffff, "flatShading": true});
