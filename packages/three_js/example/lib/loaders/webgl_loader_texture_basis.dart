...
class _MyAppState extends State<webgl_loader_texture_basis> {
  ...
  initPage() async {
    ...
    camera.position.setValues(-0.0, 0.0, 20.0);
    ...
    var material = three.MeshBasicMaterial.fromMap({"side": three.DoubleSide});
    ...
    loader.flipY = true;
    var texture = await loader.fromAsset("assets/textures/758px-Canestra_di_frutta_(Caravaggio).jpg");
