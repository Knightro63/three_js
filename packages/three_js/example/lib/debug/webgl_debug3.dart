...
class webgl_animation_keyframesState extends State<webgl_debug3> {
  ...
  initPage() async {
    ...
    var clothTexture = await loader.fromAsset('assets/textures/patterns/circuit_pattern.png');
    clothTexture!.anisotropy = 16;

    var clothMaterial = three.MeshLambertMaterial.fromMap({"alphaMap": clothTexture, "side": three.DoubleSide, "alphaTest": 0.5});
