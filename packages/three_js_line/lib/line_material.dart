...
class LineMaterial extends ShaderMaterial {  
      ...
      /* glsl */'''
        ...
        void main() {
          ...
          float alpha = opacity;
            ...
            float norm = len / (linewidth * 0.001);
  ...
  @override
	Color get color => uniforms['diffuse']['value'];
  @override
	set color(Color value ) {
    if(uniforms['diffuse'] == null){
      uniforms['diffuse'] = <String,dynamic>{
        'value': value
      };
    }
    else{
  ...
  @override
	double? get linewidth => uniforms['linewidth']['value'];
  @override
	...
	bool? get dashed => defines?.containsKey('USE_DASH');
	...
	double get dashScale => uniforms['dashScale']['value'];
	set dashScale(double  value ) {
		uniforms['dashScale']['value'] = value;
	}

  @override
	double? get dashSize =>uniforms['dashSize']['value'];
  @override
	set dashSize(double? value ) {
  ...
  @override
	double? get gapSize => uniforms['gapSize']['value'];
  @override
	set gapSize(double? value ) {
		uniforms['gapSize']['value'] = value;
	}
  @override
	double get opacity => uniforms['opacity']['value'];
  @override
	set opacity(double value ) {
    if(uniforms['opacity'] == null){
      uniforms['opacity'] = <String,dynamic>{
        'value': value
      };
    }
    else{
	...
	Vector2 get resolution => uniforms['resolution']['value'];

	set resolution(Vector2 value ) {
		uniforms['resolution']['value'].setFrom( value );
	}

  @override
	bool get alphaToCoverage => defines?.containsKey('USE_ALPHA_TO_COVERAGE') ?? false;
