...
class AngleRendererParameters{
  ...
  factory AngleRendererParameters.fromMap(Map<String,dynamic> map){
...
class AngleRenderer extends Renderer{
  ...
  List<AngleRenderList> renderListStack = [];
  List<AngleRenderState> renderStateStack = [];
  ...
  factory AngleRenderer.fromMap([Map<String, dynamic>? parameters]) {
