...
/**
 * Stage: Vertex
 * Purpose: Master template for diffuse-lit materials (Lambert).
 */
...
void main() {
    ...
    // 3. NORMAL PROCESSING (Critical for Lambert Lighting)
    ...
    // Set view position for lighting and specular calculations
