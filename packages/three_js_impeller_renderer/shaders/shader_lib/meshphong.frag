...
#include "../shader_chunk/lights_phong_pars_fragment.frag"
...
uniform MaterialUniforms {
    ...
    vec3 specular;     // Float Indices 38, 39, 40 (Highlight color)
    float shininess;   // Float Index 41           (Specular roughness exponent)
    float opacity;     // Float Index 42           (Alpha blending)
};
...
void main() {
    ...
    // Instantiate specular lighting accumulation storage structs
    ...
    // Evaluate geometry normals and apply normal map details
    ...
    // Accumulate diffuse and specular light computations
    ...
    // Combine diffuse, specular, and emissive lighting components
