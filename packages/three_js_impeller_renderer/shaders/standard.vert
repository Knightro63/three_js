...
void main() {
  ...
  //localTangent = getSkinNormal(boneMatrix, skinWeight, localTangent);

  //TransformedTN tn = defaultNormal(localNormal, localTangent); 
  ...
  //v_worldTangent = normalize(normalMatrix * localTangent);
