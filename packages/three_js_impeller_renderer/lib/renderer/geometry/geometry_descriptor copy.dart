...
class GeometryBindings{
  ...
  void bind(
    ...
    final gpu.HostBuffer host = context.createHostBuffer();
    ...
    if(material.userData[uuidVert] == null || needsUpdate) {
      ...
      material.userData['${uuidVert}_bufferView'] = gpu.BufferView(
    ...
    if(hardwareBuffers.indexCount != 0 && (material.userData[uuidIndex] == null || needsUpdate)) {
      ...
      material.userData['${uuidIndex}_bufferView'] = gpu.BufferView(
  ...
  void _bindTextures(
    ...
    if(
      ...
      gpu.Texture? texture = material.userData[uuid];
      if(texture == null){
  ...
  gpu.Texture _createTexture(
    ImageElement element,
    [
      String? cacheName,
      gpu.TextureType type = gpu.TextureType.texture2D
    ]
  ){
    ...
    final sampledTexture = context.createTexture(
      ...
      format: element.data is Uint8List?
        ...
        gpu.PixelFormat.r32g32b32a32Float:gpu.PixelFormat.r16g16b16a16Float,
  ...
  gpu.Texture _createCubeTexture(
    ...
    final cubeTexture = context.createTexture(
      gpu.StorageMode.hostVisible, // Required for host data overwrite calls
      width,
      height,
      sampleCount: 1,
      textureType: gpu.TextureType.textureCube, // Informs Impeller this has 6 face slices
      coordinateSystem: gpu.TextureCoordinateSystem.uploadFromHost, // Matches WebGL rules natively
  ...
  void _bindMaterialUniforms(
    ...
    final gpu.BufferView materialBufferView = host.emplace(materialView);
  ...
  void _bindUniforms(
    ...
    final gpu.BufferView sceneBufferView = host.emplace(sceneView);
