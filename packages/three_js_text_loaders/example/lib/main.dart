...
import 'package:three_js_core/materials/index.dart';
...
class _State extends State<WebglGeometries> {
  ...
  Future<void> initPage() async {
    ...
    pointLight.color!.setFromHSL(math.Random().nextDouble(), 1, 0.5);
  ...
  void createText(font) {
    ...
    final centerOffset = -0.5 * (textGeo.boundingBox!.max.x - textGeo.boundingBox!.min.x);
