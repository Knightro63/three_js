...
class Node {
  ...
  Node clone() {
    ...
    node.polygons = polygons.sublist(0);
    return node;
  }
  ...
  List<Polygon> allPolygons() {
    ...
    if (front != null){
      final temp = front!.allPolygons();
      if(temp.isNotEmpty)polygons.addAll(temp);
    }
    if (back != null){
      final temp = back!.allPolygons();
      if(temp.isNotEmpty)polygons.addAll(temp);
    }
    return polygons;
  }
